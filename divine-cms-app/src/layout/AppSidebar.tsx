  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Unfix Sale Transfer Add", path: "/invoice/unfix_sale_transter/create", pro: false, permission:"create_sale" },
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Cashbook Report", path: "/report/cashbook", permission:"report_balance" },
      ],
    },
  ];
